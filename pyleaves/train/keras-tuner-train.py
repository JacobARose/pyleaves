...
#     tf.reset_default_graph()
    ...
    def build_tunable_model(hp):
        ...
        return build_model(
                    name=hp.Choice('name',
                                   values=['shallow','vgg16','xception','resnet_50_v2','resnet_101_v2']
                                  ),
                    num_classes=10000,
                    frozen_layers=(0,-4),
                    input_shape=(224,224,3),
                    base_learning_rate=hp.Float(
                                                'base_learning_rate',
                                                min_value=1e-6,
                                                max__value=0.01,
                                                sampling='log'
...
if __name__=='__main__':    
    ...
    from pyleaves.leavesdb.tf_utils.tf_utils import reset_eager_session, train_val_test_split as _train_val_test_split

...
def get_callbacks(cfg, model_config, model, fold, train_data=None, val_data=None, encoder=None):
    ...
    if train_data is not None:
        callbacks.append(ImageLoggerCallback(data=train_data, freq=100, max_images=-1, name='train', encoder=encoder, neptune_logger=neptune,include_predictions=True))
    ...
    if val_data is not None:
        ...
        callbacks.append(ImageLoggerCallback(data=val_data, freq=100, max_images=-1, name='val', encoder=encoder, neptune_logger=neptune, include_predictions=True))

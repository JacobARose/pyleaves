...
# TODO (Jacob): Write generic Metric (cor Callback) subclass that tracks the value of 
# - TP
# - TN
# - FP
# - FN
...
# a. per sample for a whole epoch
# or
# b. The scalar sum of each of (TP, TN, FP, FN) per class for a whole epoch
